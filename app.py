...
# AUTO REFRESH
# -----------------------
st_autorefresh(interval=10000, key="refresh")  # refresh every 10 sec without breaking layout
...
bar_fig.update_layout(yaxis=dict(range=[0, 220]), height=300, margin=dict(l=20, r=20, t=40, b=20))
